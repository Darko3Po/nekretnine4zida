...
class PropertySeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        DB::table('re_facilities_distances')->truncate();
        ...
        foreach ($properties as $property) {
            ...
            $property->features()->attach($features->random(rand($features->count() - 8, $features->count())));

            foreach (range(1, $facilities->count()) as $facilityId) {
